...
# @description This script will install NPM CLI. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/npm-cli/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/template-npm-cli/releases"
